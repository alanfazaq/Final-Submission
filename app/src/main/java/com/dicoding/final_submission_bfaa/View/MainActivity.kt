...
import com.dicoding.final_submission_bfaa.Notification.NotificationActivity
import com.dicoding.final_submission_bfaa.R
import com.dicoding.final_submission_bfaa.View.Adapter.ListUserAdapter
import com.dicoding.final_submission_bfaa.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), ListUserAdapter.DataClickCallback{
    ...
    override fun onClick(view: View, listData: User) {
        ...
        intent.putExtra(DetailActivity.EXTRA_USER, listData)
